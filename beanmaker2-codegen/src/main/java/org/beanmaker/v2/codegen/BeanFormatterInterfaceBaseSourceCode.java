...
public class BeanFormatterInterfaceBaseSourceCode extends BaseInterfaceCode {

    public BeanFormatterInterfaceBaseSourceCode(String beanName, String packageName, Columns columns) {
        super(beanName, packageName, "FormatterInterfaceBase", columns);
