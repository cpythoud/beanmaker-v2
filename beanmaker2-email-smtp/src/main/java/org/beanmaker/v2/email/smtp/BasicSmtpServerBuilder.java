...
public class BasicSmtpServerBuilder implements MessageDispatcherBuilder {
    ...
    public BasicSmtpServerBuilder(String smtpServer) {
        this.smtpServer = smtpServer;
    }

    public BasicSmtpServerBuilder port(int port) {
    ...
    public BasicSmtpServerBuilder encryptionType(EncryptionType encryptionType) {
    ...
    public BasicSmtpServerBuilder smtpCredentials(String user, String password) {
        smtpUser = user;
    ...
    public static class SmtpServer extends AbstractSmtpServer {
        ...
        private SmtpServer(String smtpServer, int port, boolean useSSL, boolean useTLS, String smtpUser, String smtpPassword) {
            this.smtpServer = smtpServer;
            this.port = port;
            this.useSSL = useSSL;
            this.useTLS = useTLS;
